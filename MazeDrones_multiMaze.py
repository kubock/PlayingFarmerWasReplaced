...
def SunFlowerAsDrone():
	...
	spawn_drone(DroneControl.SunflowerDrome_5)
	spawn_drone(DroneControl.SunflowerDrome_6)
	spawn_drone(DroneControl.SunflowerDrome_7)
	wait_for(spawn_drone(DroneControl.SunflowerDrome_8))
